<div align="center">
  ...
  <p><strong>2588 张表情包原图 · 1816 张 GIF · 全部附带描述 · 下载后可离线使用</strong></p>
  <p>
    <a href="#开始使用">开始使用</a> ·
...
当前快照包含 **1816 张 GIF、470 张 PNG、287 张 JPG 和 15 张 WebP**，共 **2588 张**。数量与描述以 [manifest.json](./manifest.json) 为准。
