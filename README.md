<div align="center">
  <h1>贴纸素材库</h1>
  <p>给聊天和 AI Agent 准备的一份本地贴纸与表情素材库。<br>原图、动图、描述与校验清单一起保存，换台电脑也能继续用。</p>
...
这是一个可下载、可检索、可迁移的贴纸与表情素材集合。图片保存在 `emoticons/`，根目录的 `manifest.json` 记录每张图的相对路径、格式、大小、内容哈希和简短描述。
...
```text
请安装并使用 https://github.com/9Ashwin/sticker-ext 的贴纸与表情素材。
...
```text
本地贴纸素材库：/absolute/path/sticker-ext
